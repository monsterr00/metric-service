...
Registered analyzers:
    ...
    mulint       reports reentrant mutex locks
    nilfunc      check for useless comparisons between functions and nil
    nilness      check for redundant or impossible nil comparisons
    osexitcheck  check for os.Exit(1) in code
    ...
    sqlrows      check for mistakes using Rows iterator of database/sql
...
Core flags:
  ...
  -SA1031
        enable SA1031 analysis
  -SA1032
        enable SA1032 analysis
  -SA2000
  ...
  -mulint
        enable mulint analysis
  -nilfunc
        enable nilfunc analysis
  -nilness
        enable nilness analysis
  -osexitcheck
        enable osexitcheck analysis
  -pkgfact
